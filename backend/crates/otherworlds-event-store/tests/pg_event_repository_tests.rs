...
// ---------------------------------------------------------------------------
// Cycle 1: load_events returns empty Vec for nonexistent aggregate
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Cycle 2: append_events stores a single event, load_events retrieves it
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Cycle 3: Append multiple events, verify ordering
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Cycle 4: Aggregate isolation — events from different aggregates don't mix
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Cycle 5: Concurrency conflict detection (duplicate sequence_number)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Cycle 6: Sequential appends with correct expected_version
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Cycle 7: Empty events slice is a no-op
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Cycle 8: Complex JSON payload round-trip
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Cycle 9: Timestamp precision (microsecond for PostgreSQL TIMESTAMPTZ)
// ---------------------------------------------------------------------------
